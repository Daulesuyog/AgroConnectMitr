...
insert into farmers ( name, email, phone, password, farm_intro, worker_requirement, farm_location) values
  ('Suyog Daule', 'suyog67@gmail.com', '8999289355', '123', 'we grow sugarcane and rice', '2 farm workers needed for rice planting', 'Newasa'),
  ('Rutuja Daule', 'rutuja67@gmail.com', '8999289356', '123', 'we grow wheat and soybeans', '2 farm workers needed for wheat planting', 'Pune');
...
insert into workers (name, email, phone, password, skills_ofworker, capacity_ofworker, wage_per_day_ofworker, wage_per_month_ofworker) values 
 ('Kunal Dongare', 'kunal123@gmail.com', '8999289357', '123', 'plowing, sowing', 'can work 8 hours a day', 250, 7000),
 ('Manish Naik', 'manish123@gmail.com', '8999289358', '123', 'harvesting, weeding', 'Full time', 200, 6000);
